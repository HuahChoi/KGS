...
function sec2Location() {
    ...
    sec2.style.top = `${parseInt((innerHeight - sec2.clientHeight) / 2)}px`;
    ...
    document.querySelector(".sec2_checkbox").style.marginTop = `${innerHeight / 100}px`;
    document.querySelector(".sec2_checkbox").style.marginTop = `0`;
}
